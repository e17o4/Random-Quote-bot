module.exports = [
  ...
  "*Insert message here* *Or here* *No, how about here?*",
  ...
  "'OH THE HUMANITY!'",
  "Cave Johnson: When life gives you lemons, don't make lemonade. Make life take the lemons back! Get mad! 'I don't want your damn lemons!' Demand to see life's manager! I'm gonna get my engineers to invent a combustible lemon that'll burn your house down! GLaDOS: Burning people. He says what we're all thinking. – *Portal 2*",
  "insert message here",
  "insert message here",
  "insert message here",
  "insert message here",
